...
As		-- Drop Procedure [dbo].[Empprovisionsadj_GetRow_N]'','6','HR','U','HR'
Begin	
	Select
		TransNo
	,	TransDt
...
CREATE OR ALTER Procedure [dbo].[EmpFund_Confirm_Revise_Cancel_Update_N]
	@v_CoCd				Char(5)
,	@v_Typ				Char(1)
,	@v_TransNo			Char(10)
,	@v_CancelBy			Char(10)
...
,	@v_Disburse			char(1)='N'
,	@v_Appltyp			char(10)
As		-- Drop Procedure [dbo].[EmpFund_Confirm_Revise_Cancel_Update_N]'100','0','00002','admin','03/26/2016','','1200','2100','1','1'
Begin
...
As				-- Drop procedure [GetRepo_FixedPayrollCom_N] '01',''--'00032'
Begin
...
,	@v_RYear Char(4)
,	@v_EmpCd Char(10)
--Drop procedure [dbo].[GetRepo_FixedEarnDed_N]  'A4M Group - UAE ','09 ','2014 ','   '
as
...
,   @v_Typ			Char(3)
,	@v_Usercd		varchar(10)
As				-- Drop Procedure [dbo].[GetRepo_ExpiredDocument_N]'100','','','626/ALH','All','EMP'
...
,	@v_EmpCd		Char(10)
,	@v_EmpUser		Char(1)
As		-- Drop Procedure [dbo].[EmpFund_Approval_GetRow_N] '','3','01','001','U'  
Begin	
	Declare @FinalAuth Char(10)	
	Select
		TransNo[TransNo]
...
,	@v_Div		Char(5)
As
Begin--UserBranch_GetRow_N '001','01',''
...
-- Description:	<Description,,>
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[GetMessage_N]
	@success bit,
	@message VARCHAR(100)
AS
BEGIN
...
End
 ...
 Go 
CREATE OR ALTER procedure [dbo].[EmpLeave_Allowances_WithoutLeave_N]
	@v_CoCd			Char(5)
,	@v_Empcd			char(10)
As		-- Drop Procedure [dbo].[EmpLeave_Allowances_WithoutLeave_N]'01','488'
Begin
	Declare @BasicCd		Char(15)
	Declare @AmtDecs		int
	select  @BasicCd='HEDT01'+rtrim(Val) From Parameters Where Cd='BASIC' and CoCd='#'
...
,	@v_Dt2			Date
,	@orderBy		varchar(100)
As	-- Drop Procedure [GetRepo_EmpLeave_N] '100','00185','All','All','All','All'
/*
	Declare @v_CoCd		char(5)
	Set @v_CoCd = '01'sp_help EmpLeave
*/
