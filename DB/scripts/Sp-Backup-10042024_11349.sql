...
*/
	...
	Else
	  Begin
		...
		CREATE OR ALTER table dbo.#WorkingDaysTemp
		(	EmpCd char(10)  ,
			NoOfDays  numeric(18,0),
			DivCd  Char(10) 
		)

		CREATE OR ALTER table dbo.#WorkingDays
		(	EmpCd char(10) collate Latin1_General_CI_AS,
			NoOfDays  numeric(18,0),
			DivCd  Char(10) 
		)

		CREATE OR ALTER table dbo.#EmpEmpTransfer
		(	EmpCd char(10)  collate SQL_Latin1_General_CP1_CI_AS,
		...
		----------------------------------------------------------------------------Emp transfer at middle of month
		CREATE OR ALTER table dbo.#TempTable
