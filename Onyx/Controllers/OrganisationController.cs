...
namespace Onyx.Controllers
{
    ...
    public class OrganisationController : Controller
    {
        ...
        public IActionResult GetWorkingHour(string cd)
        {
            ...
            if (workingHour != null)
                model = new WorkingHourModel
                {
                    ...
                    Days = ExtensionMethod.GetDaysBetweenDateRange(workingHour.FromDt, workingHour.ToDt),
        ...
        public IActionResult GetNotification(int Cd, string processId, string docType)
        {
            ...
            ViewBag.DocumentTypeItems = _commonService.GetCodesGroups(CodeGroup.EmpDocType).Select(m => new SelectListItem
            {
                Value = m.Code.Trim(),
                Text = m.ShortDes
            });
        ...
        public IActionResult GetTravelFare(int cd, string sectCd, string classCd)
        {
            ...
            if (travelFare != null)
                model = new AirFareModel
                {
                    ...
                    Days = ExtensionMethod.GetDaysBetweenDateRange(travelFare.FromDate, travelFare.ToDate),
