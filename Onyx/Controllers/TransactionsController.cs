        ...
        public IActionResult GetEmpLeaveApproval(string transNo)
        {
            ...
            if (leaveData != null)
            {
                model = new EmpLeaveApprovalModel()
                {
                    ...
                    WpDays = ExtensionMethod.GetDaysBetweenDateRange(leaveData.WP_FromDt, leaveData.WP_ToDt),
                    WopLvDays = ExtensionMethod.GetDaysBetweenDateRange(leaveData.WOP_FromDt, leaveData.WOP_ToDt),
                    LvDateRange = ExtensionMethod.GetDateRange(leaveData.LvFrom, leaveData.LvTo),
                    WpDateRange = ExtensionMethod.GetDateRange(leaveData.WP_FromDt, leaveData.WP_ToDt),
                    WopDateRange = ExtensionMethod.GetDateRange(leaveData.WOP_FromDt, leaveData.WOP_ToDt),
